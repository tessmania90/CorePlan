...
} elseif ($path === '/api/users/edit' && $method === 'POST') { handleEditUser();
...
} elseif ($path === '/api/tasks/comments' && $method === 'GET') { handleGetTaskComments();
} elseif ($path === '/api/tasks/comment' && $method === 'POST') { handleAddTaskComment();
